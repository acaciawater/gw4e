    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download_url', models.URLField(blank=True, help_text='url for download of entire layer', null=True, verbose_name='download url')),
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='maps.Group', verbose_name='group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='maps.DocumentGroup')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('url', models.URLField()),
                ('doc', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to=maps.models.upload_to_cluster)),
